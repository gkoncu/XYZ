...
{
    public sealed class DeleteDocumentDefinitionCommandHandler
        : IRequestHandler<DeleteDocumentDefinitionCommand, int>
    {
        private readonly IApplicationDbContext _context;
        private readonly ICurrentUserService _current;

        public DeleteDocumentDefinitionCommandHandler(
