...
{
    public class CreateProgressMetricDefinitionCommandValidator : AbstractValidator<CreateProgressMetricDefinitionCommand>
    {
        public CreateProgressMetricDefinitionCommandValidator()
        {
