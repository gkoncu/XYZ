        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgeGroupMin = table.Column<int>(type: "int", nullable: true),
                    AgeGroupMax = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentityNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Parent1FirstName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Parent1LastName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Parent1Email = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Parent1PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Parent2PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassCoach", x => new { x.ClassId, x.CoachId });
                    table.ForeignKey(
                        name: "FK_ClassCoach_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClassCoach_Coaches_CoachId",
                        column: x => x.CoachId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstallmentPlan = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BodyFatPercentage = table.Column<decimal>(type: "decimal(4,1)", precision: 4, scale: 1, nullable: true),
                    VerticalJump = table.Column<decimal>(type: "decimal(4,1)", precision: 4, scale: 1, nullable: true),
                    SprintTime = table.Column<decimal>(type: "decimal(4,2)", precision: 4, scale: 2, nullable: true),
                    Endurance = table.Column<decimal>(type: "decimal(4,1)", precision: 4, scale: 1, nullable: true),
                    Flexibility = table.Column<decimal>(type: "decimal(4,1)", precision: 4, scale: 1, nullable: true),
                    TechnicalScore = table.Column<int>(type: "int", nullable: true),
                    TacticalScore = table.Column<int>(type: "int", nullable: true),
                    PhysicalScore = table.Column<int>(type: "int", nullable: true),
                    MentalScore = table.Column<int>(type: "int", nullable: true),
