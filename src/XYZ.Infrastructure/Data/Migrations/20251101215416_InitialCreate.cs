    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassAssistantCoaches", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClassAssistantCoaches_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ClassAssistantCoaches_Coaches_CoachId",
                        column: x => x.CoachId,
                        principalTable: "Coaches",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassAssistantCoaches_ClassId",
                table: "ClassAssistantCoaches",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassAssistantCoaches_CoachId",
                table: "ClassAssistantCoaches",
                column: "CoachId");

            migrationBuilder.CreateIndex(
                name: "IX_Classes_HeadCoachId",
                table: "Classes",
                column: "HeadCoachId");
